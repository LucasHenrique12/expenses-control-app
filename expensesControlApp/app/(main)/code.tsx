...
import { 
  View, TextInput, Button, StyleSheet, Alert, Keyboard, 
  Modal, Platform, ToastAndroid, TouchableOpacity, Text 
} from 'react-native';
...
const ExpensesScreen: React.FC = () => {
  ...
  const addExpense = () => {
    ...
    if (isNaN(parsedAmount) || isNaN(parsedParcelas) || parsedAmount <= 0 || parsedParcelas <= 0) {
